...
**Aktuelle Gesamtdokumentation (24.09.2026):** [Projekthandbuch](project/HANDBUCH.md), [Betrieb / Wiederherstellung](project/BETRIEB.md), [Architektur / Entwicklung](project/ENTWICKLUNG.md) und [Versions-/Abnahmestand](project/PROJEKTSTATUS.md). Die folgenden versionsbezogenen Beschreibungen und Prüfprotokolle bleiben historische Referenzen; für neue Installationen den aktuellen Leitfaden verwenden. Aggregator 1.1.0 produktiv, Display 1.0.0 R3 veröffentlicht.
