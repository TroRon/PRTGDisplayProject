...
Stand 26.09.2026: zur Veröffentlichung freigegeben. Benötigt Display-Firmware **1.1.0** und Aggregator **1.3.0** mit aktiviertem WebAdmin und beschreibbarem `ADMIN_DIRECTORY`. Produktives Aggregator-Deployment freigegeben; physische Display-Abnahme ausstehend. Bisher veröffentlichte Firmware: 1.0.3.
