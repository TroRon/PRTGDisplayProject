# Firmware 1.0.1 – Hardware-Release

Nur Waveshare ESP32-S3-Touch-LCD-5B, SKU 28151. 1024×600, 16 MB Flash, 8 MB Octal-PSRAM. ESP-IDF 5.5.0. Lokal gebaut und geprüft; die physische Abnahme der Version 1.0.1 steht aus. Vier getrennte USB-Images, kein zusammengeführter Full-Flash-Dump.
...
**Update von 1.0.0:** Am Display «Firmware → Versionen prüfen → 1.0.1 → Installieren» wählen. Aggregator- und Direktkanal werden unterstützt. Nach dem Neustart innert 120 Sekunden bestätigen. Einstellungen bleiben erhalten.
...
Neu in 1.0.1: Systemkarten behalten innerhalb ihrer Rubrik die konfigurierte Reihenfolge. Fehlende Daten verändern die Reihenfolge nicht; Statusfarben und Hinweise bleiben erhalten.
